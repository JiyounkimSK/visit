...
public class PolicyHandler{
    ...
    public void wheneverPaymentApproved_(@Payload PaymentApproved paymentApproved){
        ...
        if(paymentApproved.isMe()){
            ...
            visitReqList.setStudent(paymentApproved.getStudent());
            VisitReqListRepository.save(visitReqList);
/**
            Visit visit = new Visit();
            visit.setMatchId(paymentApproved.getMatchId());
            visit.setStudent(paymentApproved.getStudent());
 ...
 **/
    ...
    public void wheneverPaymentCanceled_(@Payload PaymentCanceled paymentCanceled){
        ...
        if(paymentCanceled.isMe()){
            ...
            VisitReqListRepository.findById(paymentCanceled.getMatchId()).ifPresent(Visit->{
                VisitReqListRepository.delete(Visit);
            });
        }
    }
